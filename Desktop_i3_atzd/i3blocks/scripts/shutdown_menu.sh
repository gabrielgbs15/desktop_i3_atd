...
HLBG_COLOR="${HLBG_COLOR:-#284374}"
BORDER_COLOR="${BORDER_COLOR:-#222222}"

# Options not related to colors
ROFI_TEXT="${ROFI_TEXT:-Power menu: }"
ROFI_OPTIONS=(${ROFI_OPTIONS:--theme-str 'window {width: 300px; } configuration {show-icons: false;}' -location 0 -l 5})
...
menu=(
  ...
  [  Lock]="/home/gabera/.config/i3blocks/scripts/lock.sh"
  [󰹿  Cancel]=""
)
menu_nrows=${#menu[@]}
